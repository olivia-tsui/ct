...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: nkyODYZrJ1g/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: TiF4cdBPWl8/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__xxmGp)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__fNp0D)}
              />
            </React.Fragment>
          ),
          value: args.children
